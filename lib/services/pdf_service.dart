...
Future<Uint8List> generatePdf(
    ...
    bool signed,
    String uid,
    ColorANDLogoProvider colorANDLogoProvider,
    String lastName,
    String firstName,
    String email,
    {pc.RSAPublicKey? publicKey}) async {
  String currentOrg = colorANDLogoProvider.customerName;
    ...
    pw.Page(
      build: (pw.Context context) => pw.Column(
        children: [
          ...
          pw.SizedBox(height: 10),
          pw.Text('edConnect User ID: $uid', style: pw.TextStyle(fontSize: 14)),
          ...
          if (signed)
            pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  pw.Text(
                    'This form was cryptographically signed by the user with the NewsApp System.',
                    style: pw.TextStyle(
                      fontSize: 10,
                    ),
                  ),
